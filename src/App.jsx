          ...
          <Suspense
            fallback={
              <ClipLoader
                color="#2F89FC"
                loading
                cssOverride={{ position: "fixed", top: "50%", right: "50%" }}
              />
            }
          >
            <Routes>
              ...
              <Route
                path="/dashboard/doctor/:bookingId"
              ...
              <Route
                ...
                element={<DashboardBookingList />}
              />
              <Route
                path="/dashboard/waiting-pay"
                element={<DashboardWaitingPay />}
              />
              <Route
                path="/dashboard/waiting-list"
                element={<DashboardWaitingPatients />}
              />
              <Route path="/waiting-list" element={<WaitingList />} />
              <Route path="/dashboard/medicine" element={<Medicine />} />
              <Route path="/dashboard/staff" element={<DashboardStaff />} />
              <Route
                path="/dashboard/assistant/:bookingId"
